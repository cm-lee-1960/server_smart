...
class LastMeasDayClose(models.Model):
    ...
    ul_nr_percent = models.FloatField(null=True, blank=True, verbose_name='UL LTE전환율')  # 5G->NR 전환 전환율(ul)
    udpJitter = models.FloatField(null=True, blank=True, verbose_name='지연시간')  # 지연시간
    telesucc = models.FloatField(null=True, blank=True, verbose_name='통화성공율')  
    datasucc = models.FloatField(null=True, blank=True, verbose_name='전송성공율')
    rsrpavg = models.FloatField(null=True, blank=True, verbose_name='평균RSRP')
    sinravg = models.FloatField(null=True, blank=True, verbose_name='평균SINR')
    lteband = models.FloatField(null=True, blank=True, verbose_name='LTE평균대역')
