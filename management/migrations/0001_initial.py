    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('centerEngName', models.CharField(blank=True, max_length=100, null=True, verbose_name='센터영문명')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('userchatId', models.CharField(max_length=25, verbose_name='채팅ID')),
                ('firstName', models.CharField(max_length=100, verbose_name='First Name')),
                ('lastName', models.CharField(max_length=100, verbose_name='Last Name')),
                ('userName', models.CharField(max_length=100, verbose_name='User Name')),
                ('center', models.CharField(max_length=100, verbose_name='센터명')),
                ('chatId', models.CharField(max_length=25, verbose_name='채팅방ID')),
                ('allowed', models.BooleanField(default=False, verbose_name='허용')),
                ('isBot', models.BooleanField(default=False, verbose_name='Is Bot')),
            ],
            options={
