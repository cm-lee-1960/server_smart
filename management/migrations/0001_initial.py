    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('networkId', models.CharField(blank=True, choices=[('5G', '5G'), ('WiFi', 'WiFi'), ('LTE', 'LTE'), ('3G', '3G')], max_length=10, null=True, verbose_name='단말유형')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('morphology', models.CharField(blank=True, choices=[('테마', '테마'), ('취약지구', '취약지구'), ('인빌딩', '인빌딩'), ('커버리지', '커버리지'), ('행정동', '행정동')], max_length=100, null=True, verbose_name='모폴러지')),
