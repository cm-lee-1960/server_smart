...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SentXroshotMessage',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message', models.TextField(blank=True, null=True, verbose_name='내용')),
                ('receiver', models.TextField(verbose_name='번호')),
                ('send_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='송신시간')),
                ('result', models.CharField(blank=True, max_length=10, null=True, verbose_name='결과')),
            ],
        ),
    ]
